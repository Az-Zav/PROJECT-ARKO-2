...
public class LoginPanel extends JPanel {
    ...
    static final String INNER_CARD_LOGIN = "LOGIN_FORM";
    static final String INNER_CARD_CHANGE_PASSWORD = "CHANGE_PASSWORD";
    ...
    private final JPanel innerDeck = new JPanel(innerLayout);
    ...
    public LoginPanel(MainAppShell appShell) {
        ...
        innerDeck.setOpaque(false);

        JPanel loginFormCard = buildLoginFormCard();
        innerDeck.add(loginFormCard, INNER_CARD_LOGIN);

        StaffDAO staffDAO = new StaffDAO();
        this.authController = new AuthController(staffDAO);
        LoginController loginController = new LoginController(
                txtUser, txtPass, btnLogin, errorLabel, appShell, authController, this);

        changePasswordPanel = new ChangePasswordPanel(authController, loginController, this, null);
        innerDeck.add(changePasswordPanel, INNER_CARD_CHANGE_PASSWORD);

        add(innerDeck, BorderLayout.CENTER);
        innerLayout.show(innerDeck, INNER_CARD_LOGIN);
    }

    public void showChangePasswordCard(LoginResult loginResult) {
        changePasswordPanel.bind(loginResult);
        innerLayout.show(innerDeck, INNER_CARD_CHANGE_PASSWORD);
    }
    ...
    public void prepareForReturn() {
        showLoginCard();
        if (changePasswordPanel != null) changePasswordPanel.clearForm();
        txtUser.setText("");
        txtPass.setText("");
        errorLabel.setText(" ");
    }
